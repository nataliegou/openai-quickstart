...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--target_language', type=str, help='Need to translate into the language')
        self.parser.add_argument('--output_file_path', type=str, help='The file address to which the translated file needs to be written')
